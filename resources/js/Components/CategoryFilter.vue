...
<template>
    <Listbox v-model="selected">
        <div class="relative">
            ...
            >
                <ListboxOptions class="absolute mt-1 max-h-60 w-max overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm">
                    <ListboxOption
